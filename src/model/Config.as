package model
{
	...
	public class Config
	{
		...
		public function set photoPath(s:String):void {
			prefsXML.photoPath=s;
		}
		
		public function get photoPath():String {
			return prefsXML.photoPath;
		}
		
		public function set pushFolder(s:String):void {
			prefsXML.pushFolder=s;
		}
		
		public function get pushFolder():String {
			return prefsXML.pushFolder;
		}
		
		public function set watchFolder(s:String):void {
			prefsXML.watchFolder=s;
		}
		
		public function get watchFolder():String {
			return prefsXML.watchFolder;
		}
		
		public function set serverPort(s:Number):void {
			prefsXML.serverPort=s.toString();
		}
		
		public function get serverPort():Number {
			return parseInt(prefsXML.serverPort);
		}
		...
		public function saveApplicationVariables(values:Object):void
		{
			...
			if (prefsFile.exists) {
				...
				prefsXML.watchFolder = values.watchFolder;
